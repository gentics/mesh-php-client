...
Methods\WebrootMethodsInterface
{
    ...
    {
        return $this->buildRequest("DELETE", "/" . encodeSegment($projectName) . "/nodes/" . $nodeUuid . "/languages/" . $languageTag . "/published", null, $parameters);
    }

    public function getNodePublishStatus(string $projectName, string $nodeUuid, array $parameters = []): MeshRequest
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/nodes/" . $nodeUuid . "/published", null, $parameters);
    }
    ...
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/tagFamilies/" . $tagFamilyUuid . "/tags", $request);
    }

    public function findTagByUuid(string $projectName, string $tagFamilyUuid, string $uuid, array $parameters = []): MeshRequest
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/tagFamilies/" . $tagFamilyUuid . "/tags/" . $uuid, null, $parameters);
    }

    public function updateTag(string $projectName, string $tagFamilyUuid, string $uuid, $request): MeshRequest
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/tagFamilies/" . $tagFamilyUuid . "/tags/" . $uuid, $request);
    }

    public function deleteTag(string $projectName, string $tagFamilyUuid, string $uuid): MeshRequest
    {
        return $this->buildRequest("DELETE", "/" . encodeSegment($projectName) . "/tagFamilies/" . $tagFamilyUuid . "/tags/" . $uuid);
    }

    public function findTags(string $projectName, string $tagFamilyUuid, array $parameters = []): MeshRequest
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/tagFamilies/" . $tagFamilyUuid . "/tags", null, $parameters);
    }
    ...
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/tagFamilies/" . $uuid, null, $parameters);
    }

    public function findTagFamilies(string $projectName, array $parameters = []): MeshRequest
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/tagFamilies", null, $pagingInfo);
    }

    public function createTagFamily(string $projectName, $request): MeshRequest
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/tagFamilies", $request);
    }

    public function deleteTagFamily(string $projectName, string $uuid): MeshRequest
    {
        return $this->buildRequest("DELETE", "/" . encodeSegment($projectName) . "/tagFamilies/" . $uuid);
    }

    public function updateTagFamily(string $projectName, string $tagFamilyUuid, $request): MeshRequest
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/tagFamilies/" . $tagFamilyUuid, $request);
    }
    ...
    {
        return handleRequest("POST", "/" . encodeSegment($projectName) . "/search/nodes", $query, $parameters);
    }

    public function searchProjectNodesRaw(string $project, string $query, array $parameters = []): MeshRequest
    {
        return handleRequest("POST", "/" . encodeSegment($projectName) . "/rawSearch/nodes", $query, $parameters);
    }
    ...
    {
        return handleRequest("POST", "/" . encodeSegment($projectName) . "/search/tagFamilies", $query, $parameters);
    }

    public function searchProjectTagFamiliesRaw(string $projectName, string $json): MeshRequest
    {
        return handleRequest("POST", "/" . encodeSegment($projectName) . "/rawSearch/tagFamilies", $query, $parameters);
    }
    ...
    {
        return handleRequest("POST", "/" . encodeSegment($projectName) . "/search/tags", $query, $parameters);
    }

    public function searchProjectTagsRaw(string $projectName, string $json): MeshRequest
    {
        return handleRequest("POST", "/" . encodeSegment($projectName) . "/rawSearch/tags", $query, $parameters);
    }
    ...
    {
        return prepareRequest(GET, "/" . encodeSegment($name), null, $parameters);
    }
    ...
    public function graphQL(string $project, $query, array $parameters = []): MeshRequest
    {
        $path = "/" . encodeSegment($projectName) . "/graphql";
    ...
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/branches", $branchCreateRequest, $parameters);
    }

    public function createBranchWithUuid(string $projectName, string $uuid, $branchCreateRequest, array $parameters = []): MeshRequest
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/branches/" . $uuid, $branchCreateRequest, $parameters);
    }

    public function findBranchByUuid(string $projectName, string $branchUuid, array $parameters = []): MeshRequest
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/branches/" . $branchUuid, null, $parameters);
    }

    public function findBranches(string $projectName, array $parameters = []): MeshRequest
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/branches", null, $parameters);
    }

    public function updateBranch(string $projectName, string $branchUuid, $request): MeshRequest
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/branches/" . $branchUuid, $request);
    }

    public function getBranchSchemaVersions(string $projectName, string $branchUuid): MeshRequest
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/branches/" . $branchUuid . "/schemas");
    }

    public function assignBranchSchemaVersions(string $projectName, string $branchUuid, $schemaVersionReferences): MeshRequest
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/branches/" . $branchUuid . "/schemas", $schemaVersionReferences);
    }

    public function getBranchMicroschemaVersions(string $projectName, string $branchUuid): MeshRequest
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/branches/" . $branchUuid . "/microschemas");
    }
    ...
    public function assignBranchMicroschemaVersions(string $projectName, string $branchUuid,
        ...
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/branches/" . $branchUuid . "/microschemas", $microschemaVersionReferences);
    }

    public function migrateBranchSchemas(string $projectName, string $branchUuid): MeshRequest
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/branches/" . branchUuid . "/migrateSchemas", $microschemaVersionReferences);
    }

    public function migrateBranchMicroschemas(string $projectName, string $branchUuid): MeshRequest
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/branches/" . branchUuid . "/migrateMicroschemas");
    }
    ...
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/schemas", null, $parameters);
    }
    ...
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/schemas/" . $schemaUuid);
    }

    public function unassignSchemaFromProject(string $projectName, string $schemaUuid): MeshRequest
    {
        return $this->buildRequest("DELETE", "/" . encodeSegment($projectName) . "/schemas/" . $schemaUuid);
    }

    public function assignMicroschemaToProject(string $projectName, string $microschemaUuid): MeshRequest
    {
        return $this->buildRequest("POST", "/" . encodeSegment($projectName) . "/microschemas/" . $microschemaUuid);
    }

    public function unassignMicroschemaFromProject(string $projectName, string $microschemaUuid): MeshRequest
    {
        return $this->buildRequest("DELETE", "/" . encodeSegment($projectName) . "/microschemas/" . $microschemaUuid);
    }

    public function findProjectMicroschemas(string $projectName, array $parameters = []): MeshRequest
    {
        return $this->buildRequest("GET", "/" . encodeSegment($projectName) . "/microschemas", null, $parameters);
    }
